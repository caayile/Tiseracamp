...
@section('content')
<div class="mb-6">
    <p class="text-sm text-ink-soft">Tinjau formulir & dokumen lowongan magang, lalu terima atau tolak pendaftar.</p>
</div>
            ...
            <div class="card-soft p-5">
                <div class="flex flex-wrap items-start justify-between gap-4">
                    ...
                    @if ($application->isPending() || $application->status === 'under_review')
                        <form method="POST" action="{{ route('admin.applications.review', $application) }}" class="w-full max-w-xs space-y-3 sm:w-64">
                            @csrf
