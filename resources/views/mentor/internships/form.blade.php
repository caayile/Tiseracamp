...
<div class="mb-6">
    <a href="{{ $program->exists ? route('mentor.internships.curriculum', $program) : route('mentor.internships.index') }}" class="btn-secondary">← Kembali</a>
</div>
...
<form method="POST"
    ...
    <div class="flex flex-wrap gap-3">
        ...
        <a href="{{ $program->exists ? route('mentor.internships.curriculum', $program) : route('mentor.internships.index') }}" class="btn-secondary">Batal</a>
    </div>
</form>
@endsection
