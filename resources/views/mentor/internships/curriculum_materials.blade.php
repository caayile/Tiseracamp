...
<div class="card-soft mb-6 p-5">
    <form method="POST" action="{{ route('mentor.materials.store', $module) }}" enctype="multipart/form-data" class="space-y-4" data-rich-form>
        ...
        <div data-lesson-panel="video" class="space-y-3 hidden">
            <div>
                <label class="mb-1.5 block text-sm font-medium text-ink">Deskripsi video</label>
                <textarea name="description" rows="3" class="input-field" placeholder="Jelaskan isi video ini untuk peserta"></textarea>
            </div>
            <div>
