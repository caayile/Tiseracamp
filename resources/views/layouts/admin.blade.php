                ...
                @foreach ($items as $item)
                    @php
                        ...
                        $itemRoute = isset($item['params'])
                            ...
                            : route($item['route']);
                    @endphp
                    <a href="{{ $itemRoute }}" class="panel-sidebar-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition {{ $isActive ? 'is-active' : '' }}">
