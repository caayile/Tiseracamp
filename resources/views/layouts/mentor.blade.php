            ...
            @php
                $navGroups = [
                    ...
                    'Bootcamp' => [
                        ...
                        ['label' => 'Review Tugas Bootcamp', 'route' => 'mentor.submissions.bootcamp', 'match' => ['mentor.submissions.bootcamp', 'mentor.submissions.show'], 'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
                    ...
                    'Magang' => [
                        ...
                        ['label' => 'Review Tugas Magang', 'route' => 'mentor.submissions.internship', 'match' => ['mentor.submissions.internship', 'mentor.submissions.show'], 'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
            ...
            @foreach ($navGroups as $groupLabel => $items)
                ...
                @foreach ($items as $item)
                    @php
                        ...
                        if ($isActive && request()->routeIs('mentor.submissions.show')) {
                            $currentType = request()->route('submission')?->assignment?->lesson?->module?->program?->type;
                            $isActive = ($item['route'] === 'mentor.submissions.internship' && $currentType === 'internship')
                                || ($item['route'] === 'mentor.submissions.bootcamp' && $currentType === 'bootcamp');
                        }
                    @endphp
