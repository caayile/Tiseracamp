...
<section class="mx-auto max-w-3xl space-y-4 px-4 py-10">
    ...
    @empty
        <div class="card-soft p-10 text-center">
            <p class="font-display text-lg font-semibold">Belum ada pendaftaran magang</p>
            <p class="mt-2 text-sm text-ink-soft">Daftar program magang untuk memulai proses seleksi.</p>
            <a href="{{ route('programs.index', ['type' => 'internship']) }}" class="btn-primary mt-4 inline-flex">Jelajahi magang</a>
        </div>
    @endforelse
