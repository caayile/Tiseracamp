...
<button
    type="button"
    data-theme-toggle
    onclick="return window.__tsToggleTheme ? window.__tsToggleTheme(event) : false"
...
>
    <svg data-theme-icon="sun" class="pointer-events-none h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    ...
    <svg data-theme-icon="moon" class="pointer-events-none h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
